    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                // IsInStock and IsLowInStock are computed properties - excluded from column mappings
                entity.Property(e => e.CreatedBy).HasColumnName("createdby");
                entity.Property(e => e.CreatedOn).HasColumnName("createdon");
                entity.Property(e => e.UpdatedOn).HasColumnName("updatedon");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                // FullName is a computed property - excluded from column mappings
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                // Tax, SubTotal, and Total are computed properties (=> syntax) - excluded from column mappings
                entity.Property(e => e.CreatedBy).HasColumnName("createdby");
                entity.Property(e => e.CreatedOn).HasColumnName("createdon");
                entity.Property(e => e.UpdatedOn).HasColumnName("updatedon");
